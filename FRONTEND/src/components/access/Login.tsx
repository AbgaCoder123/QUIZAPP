...
function Login() {
  ...
  return (
    <MainContainer addtional_class="flex items-center overflow-hidden relative">
      ...
      <Container addtional_class="gap-5 flex flex-col items-center justify-center h-full">
        <Accesstitle
          text={
            <p>
              Log in to <span className="primary-text">Escroll</span>
            </p>
          }
        />
        <form
